...
# RentString Consulting - Terms and conditions

1. **Preamble**: This Agreement, signed on Jan 10, 2016 (hereinafter: Effective Date) governs the relationship between Licensee, a Business Entity, (hereinafter: Licensee) and oppr, a duly registered brand in whose principal place of business is Avenida Rovisco Pais 1 (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using RentString (hereinafter: The Software) created and owned by Licensor, as detailed herein
